package com.mvv.payments_service.infra.amqp.config;
...
public class RabbitMqConfig {
    ...
    private static final String QUEUE = "payments.commands.queue";
    private static final String ROUTING_KEY = "command.payments.#";
