...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<SimpleError> handleDuplicateRegisterException(DuplicateRegisterException e) {
        ...
        SimpleError simpleError = new SimpleError(HttpStatus.CONTINUE.value(), e.getMessage());
    ...
    public ResponseEntity<SimpleError> handleDefaultErrors(RuntimeException e) {
