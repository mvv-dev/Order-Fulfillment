package com.mvv.orders_service.infra.amqp.config;
...
public class RabbitMqConfig {
    ...
    private static final String QUEUE = "orders.commands.queue";
    private static final String ROUTING_KEY = "command.orders.#";
